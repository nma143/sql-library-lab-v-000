...
def select_series_title_with_most_human_characters
  ...
  "SELECT series.title FROM characters LEFT OUTER JOIN series ON series.id=characters.series_id WHERE characters.species='human' ORDER BY COUNT(characters.species)"
end
