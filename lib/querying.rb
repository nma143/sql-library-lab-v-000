...
def select_series_title_with_most_human_characters
  ...
  "SELECT series.title, COUNT(characters.species) FROM characters LEFT OUTER JOIN series ON series.id=characters.series_id WHERE characters.species='human' GROUP BY series.title ORDER BY COUNT(characters.species) DESC"
end
