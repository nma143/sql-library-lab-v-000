...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name COUNT(character_books.character_id) FROM characters LEFT OUTER JOIN character_books ON character_books.character_id=characters.id GROUP BY characters.id"
end
